  ...
  return (
    <div>
      ...
      <div className=' main-content-of-page'>
        <h3 style={{ color: 'rgb(3, 54, 94)', textAlign: 'center' }}>  {language === "English" ? "Board Exam Result " : " बोर्ड परीक्षेचा निकाल"}</h3>
        ...
        <Link to="/failed">
          {language === "English" ? (
            <button className="btn btn-primary">Go to Re-Exam Page</button>
          ) : (
            <button className="btn btn-primary">पुनर परिषा</button>
          )}
        </Link>
        {selectedStudents.length > 0 && (
          <div className="mt-4">
            <table className="table table-striped table-bordered custom-table">
              <thead>
                <tr>
                  <th className="custom-width">{language === "English" ? "Roll No " : "हजरी क्र"}</th>
