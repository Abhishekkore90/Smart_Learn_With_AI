...
import { ArrowLeft, Languages, Eye, School, CheckCircle2, ChevronRight, Upload, Trash2 } from "lucide-react";
...
// Photo Uploader Component for Evidences
const PhotoUploader = ({ standardId, lang }: { standardId: number; lang: "mr" | "en" }) => {
      ...
      <div className="bg-[#fbcfe8] rounded-[2rem] p-5 md:p-6 shadow-sm relative overflow-hidden">
        ...
        {photoPreview ? (
          <div className="flex items-center gap-4 bg-white/70 p-3 rounded-2xl border border-pink-300/50 backdrop-blur-md shadow-sm relative group">
            <div className="size-16 rounded-xl overflow-hidden bg-pink-100 flex-shrink-0 border border-pink-200">
               <img src={photoPreview} alt="Evidence" className="w-full h-full object-cover" />
            </div>
            <div className="flex-1 min-w-0">
               <p className="text-pink-950 font-black text-sm truncate">{fileName}</p>
          ...
          >
             ...
             <div className="text-center">
                <p className="text-pink-900 font-black text-sm tracking-wide">
                   {lang === "mr" ? "फोटो निवडा किंवा येथे ड्रॅग करा" : "Select photo or drag here"}
                </p>
                <p className="text-pink-700/70 text-xs font-bold mt-1">
                   {lang === "mr" ? "फक्त प्रतिमा फायली (PNG, JPG)" : "Image files only (PNG, JPG)"}
                </p>
             </div>
          </div>
        )}
...
const standardsDetailData: Record<number, {
  ...
  1: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ NEP-2020 आणि NCF, SCF नुसार विद्यार्थ्यांच्या शिक्षण आणि विकासाच्या दृष्टीने त्याची परिणामकारकता पाहण्यासाठी मुख्याध्यापक आणि शिक्षक अध्यापन पद्धतींशी संबंधित नियमित विश्लेषण करतात.", isGreen: true }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Headmaster and teachers conduct regular analysis related to teaching methods to check their effectiveness from the perspective of student learning and development in accordance with NEP-2020 and NCF, SCF.", isGreen: true }
      ],
      hasEvidence: true
    }
  },
  2: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शिक्षक- पालक सभांमध्ये अध्यापन नियोजनावर चर्चा केली जाते व त्याची अंमलबजावणी सर्व वर्गांमध्ये केली जाते.", isGreen: true }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Teaching plans are discussed in teacher-parent meetings and implemented in all classes.", isGreen: true }
      ],
      hasEvidence: true
    }
  },
  3: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ नावीन्यपूर्ण अध्यापनशास्त्र आणि त्यांचे फायदे आणि अध्ययन निष्पत्ती यावर केंद्र परिषदांमध्ये इतर शाळांसोबत परस्पर संवाद साधणारी सत्रे आयोजित केली जातात.", isGreen: true },
        { text: "४.२ सर्व इयत्तांमध्ये नावीन्यपूर्ण अध्यापनशास्त्र वापरून सर्व विषय शिकवले जातील याची खात्री करण्यासाठी शाळेने तिच्या सर्व पाठ नियोजनांचे पुनरावलोकन केले आहे.", isGreen: true }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Inter-active sessions are organized with other schools in cluster conferences on innovative pedagogy, its benefits and learning outcomes.", isGreen: true },
        { text: "4.2 The school has reviewed all its lesson plans to ensure that all subjects are taught using innovative pedagogy in all grades.", isGreen: true }
      ],
      hasEvidence: true
    }
  },
  4: {
    ...
    en: {
      ...
      options: [
        ...
        { text: "Not Applicable", isGreen: true }
      ]
    }
  },
  5: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शिक्षकांचे अध्यापन विद्यार्थ्यांना चांगले समजते.", isGreen: true },
        { text: "४.२ विद्यार्थ्यांचा अध्ययन स्तर उंचावला आहे.", isGreen: true }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students understand teachers' instruction well.", isGreen: true },
        { text: "4.2 Students' learning levels have improved.", isGreen: true }
      ],
      hasEvidence: true
    }
  },
  6: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळा अध्ययन निष्पत्तीमधील प्रगतीचा वेळोवेळी आढावा घेऊन मागे असलेल्या विद्यार्थ्यांसाठी कृती कार्यक्रमाची आखणी करते.", isGreen: true }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 The school reviews progress in learning outcomes from time to time and plans action programs for students who are lagging behind.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1rHWFIpAoEkFBCLI5N-xWjFhu5IakCyd"
    }
  },
  7: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ विद्यार्थी त्यांच्या अध्ययन कक्षा वृद्धीसाठी आणि आकलनात्मक संकल्पनांचे सादरीकरण करण्यासाठी, माहितीपत्रके, पोर्टफोलिओ, दस्तऐवज, पेपर, लेख, जर्नल्स, चित्रपट, ग्राफिक्स इत्यादी स्वतःची क्षमता वाढविण्यासाठी तंत्रज्ञानाचा वापर करतात.", isGreen: true }
      ]
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students use technology to expand their learning horizons, present conceptual understandings, and build their own capacity through brochures, portfolios, documents, papers, articles, journals, films, graphics, etc.", isGreen: true }
      ]
    }
  },
  8: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळा शिक्षकांच्या मूल्यांकनासह स्वयं-मूल्यांकन आणि सहाध्यायी मूल्यांकन करून प्रकल्प-आधारित आणि पृच्छा -आधारित अध्ययन, प्रश्नमंजुषा, भूमिका, गटकार्य, पोर्टफोलिओ इत्यादी द्वारे मुलांच्या प्रगतीचा आढावा घेते.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1rHWFIpAoEkFBCLI5N-xWjFhu5IakCyd"
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 The school reviews children's progress through project-based and inquiry-based learning, quizzes, role plays, group work, portfolios, etc., along with teacher evaluation, self-evaluation, and peer evaluation.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1rHWFIpAoEkFBCLI5N-xWjFhu5IakCyd"
    }
  },
  9: {
    mr: {
      ...
      options: [
        { text: "१.१ प्रत्येक विद्यार्थ्याला पर्यावरण संवर्धन आणि हवामान बदलाविषयी पुरेशी जागरूकता संपादन करण्यासाठी प्रोत्साहित केले जाते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Every student is encouraged to gain adequate awareness about environmental conservation and climate change.", isGreen: true },
  ...
  17: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेमध्ये बैठे खेळ,मैदानी खेळ व योगाभ्यास घेतला जातो. या मध्ये दिव्यांगाना सहभागी केले जाते. शाळेमध्ये दिव्यांगासह प्राथमिक खेळाची सुविधा उपलब्ध आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Indoor games, outdoor games, and yoga practices are conducted in the school, involving divyang (specially-abled) students. Primary play facilities are available in the school including for divyang students.", isGreen: true },
  ...
  18: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेतील सर्व मुलांची वार्षिक आरोग्य तपासणी केली जाते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Annual health check-ups are conducted for all children in the school.", isGreen: true },
  ...
  19: {
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 The school ensures primary screening of all children using the PRASHASHT app.\nTeachers bring their PRASHASHT-based observations to the attention of parents.", isGreen: true },
  ...
  21: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ विद्यार्थ्यांना त्यांच्या समाज, प्राणी आणि निसर्गाप्रती असलेल्या कर्तव्यांची जाणीव करून दिली जाते.", isGreen: true }
      ]
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students are made aware of their duties towards society, animals, and nature.", isGreen: true }
      ]
    }
  },
  22: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ विद्यार्थ्यांचे मूल्यमापन झाल्यावर विद्यार्थ्यांची संपादणूक वाढविण्यासाठी आवश्यकतेनुसार कृती कार्यक्रम हाती घेतला जातो", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 After student assessment, action programs are undertaken as required to enhance student achievement.", isGreen: true },
  ...
  23: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शाळेतील शिक्षक मूल्यांकनाच्या विविध पद्धतींमध्ये प्रशिक्षित आहेत आणि त्यांनी सर्व इयत्तांमध्ये सहयोगी आणि स्व-मूल्यांकन करण्यास सुरुवात केली आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Teachers in the school are trained in various assessment methods and have started peer and self-assessment across all grades.", isGreen: true },
  ...
  25: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शाळेत समग्र प्रगती पत्रक (HPC) आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 The school has a Holistic Progress Card (HPC).", isGreen: true },
  ...
  28: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ PAT च्या अहवालावर आधारित कृतीकार्यक्रम तयार केला आहे.\n३.२ PAT च्या निकालावर आधारित अध्ययन निष्पत्तीनुसार सर्व विद्यार्थ्यांना अतिरिक्त अध्यायाच्या संधी उपलब्ध करून दिल्या जातात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 An action program based on the PAT report has been prepared.\n3.2 Additional learning opportunities are provided to all students according to learning outcomes based on PAT results.", isGreen: true },
  ...
  29: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ इयत्ता पहिली ते तिसरीला अध्यापन करणाऱ्या सर्व शिक्षकांनी FLN/NISHTHA मॉड्युल पूर्ण केले आहे.\n३.२. पूर्वतयारी स्तरावर इयत्ता चौथी आणि पाचवीला अध्यापन करणाऱ्या सर्व शिक्षकांनी निष्ठा प्राथमिक मॉड्युल पूर्ण केले आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 All teachers teaching classes I to III have completed FLN/NISHTHA modules.\n3.2 All teachers teaching classes IV and V at the preparatory stage have completed NISHTHA primary modules.", isGreen: true },
  ...
  30: {
    mr: {
      ...
      options: [
        ...
        { text: "१. पायाभूत आणि पूर्वतयारी वर्गातील (इयत्ता पहिली ते पाचवी) शंभर टक्के विद्यार्थ्यांना प्रादेशिक/स्थानिक भाषेतील इयत्ता निहाय पूरक अध्यापन साहित्य वापरण्यासाठी उपलब्ध आहे.", isGreen: true },
        { text: "लागू नाही" }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "1. One hundred percent of students in foundational and preparatory stages (grades I to V) have access to grade-wise supplementary teaching learning materials in regional/local languages.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1A6KCuKZtaJAuexE0nQy8X3gQli-zoEnR"
    }
  ...
  31: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ वाचन साक्षरता आणि गणित साक्षरतेसाठी प्रादेशिक भाषेत तसेच स्थानिक भाषेत /बोली/ मातृभाषेत अध्ययन अध्यापन साहित्याची उपलब्धता आहे.\n२.२ मुले त्यांच्या भाषेतील कथापुस्तकांमधून लहान लहान उतारे मोठ्याने वाचतात, वाचन कौशल्य दाखवितात, त्यांना त्यांच्या स्वतःच्या संस्कृतीबद्दल अभिमान वाटतो आणि त्याच वेळी शाळेतील सर्व संस्कृतींचा ते आदर करतात", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Availability of teaching-learning materials for reading literacy and mathematical literacy in the regional language as well as local language/dialect/mother tongue.\n2.2 Children read aloud short passages from storybooks in their language, demonstrate reading skills, feel proud of their own culture, and at the same time respect all cultures in the school.", isGreen: true },
  ...
  32: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ पायभूत आणि पूर्व तयारी वर्गातील (इयत्ता पहिली ते पाचवी ) १००% विद्यार्थ्यांना प्रादेशिक/ स्थानिक भाषेतील इयत्तानिहाय पूरक अध्यापन साहित्य वापरण्यासाठी उपलब्ध आहे.", isGreen: true },
        { text: "लागू नाही" }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 100% of students in foundational and preparatory classes (grades I to V) have access to grade-wise supplementary teaching learning materials in regional/local languages.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1AM9SHrgUARde9GGHVvdXCOI301S2fpK"
    }
  ...
  33: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शिक्षक इयत्ता पहिली व दुसरीच्या विद्यार्थ्यांच्या मूल्यांकन निष्कर्षाचा वापर करून संबंधित वर्गातील प्रत्येक विद्यार्थ्याच्या शिक्षणातील अंतर भरून काढण्यासाठी वैयक्तिक अध्ययन योजना विकसित करतात.", isGreen: true },
        { text: "लागू नाही" }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Teachers develop individual learning plans to bridge the learning gaps of each student in the respective class using assessment findings of class I and II students.", isGreen: true },
        { text: "Not Applicable" }
      ],
      hasEvidence: true
    }
  ...
  34: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ इयत्ता तिसरी पर्यंत पोहोचलेल्या सर्व मुलांनी साक्षरता आणि संख्याज्ञानाची मूलभूत कौशल्ये आत्मसात केली आहेत हे सुनिश्चित करण्यासाठी शाळा FLN कृतींचे बारकाईने निरीक्षण करते.", isGreen: true },
        { text: "लागू नाही" }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 The school closely monitors FLN activities to ensure that all children reaching class III have acquired basic literacy and numeracy skills.", isGreen: true },
        { text: "Not Applicable" }
      ],
      hasEvidence: true
    }
  ...
  35: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शिक्षक जवळच्या शाळांसोबत अध्ययन अध्यापन अनुभव देवाणघेवाण कार्यक्रम आयोजित करतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Teachers organize learning-teaching experience exchange programs with nearby schools.", isGreen: true },
  ...
  36: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेमध्ये विद्यार्थ्यांना त्यांच्या करिअर मार्गदर्शन, मानसिक आरोग्य आणि भावनिक आरोग्याशी संबंधित समस्यांमध्ये समुपदेशन केले जाते .", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Students are provided counseling in the school for issues related to their career guidance, mental health, and emotional well-being.", isGreen: true },
  ...
  37: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेने गेल्या वर्षभरात अध्ययन अध्यापनाची गुणवत्ता सुधारण्यासाठी एक नाविन्यपूर्ण /अभिनव प्रकल्प हाती घेतला आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 The school has undertaken an innovative/novel project to improve the quality of learning and teaching over the past year.", isGreen: true },
  ...
  38: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळा विविध सामाजिक,आर्थिक आव्हानांना सामोरे जाण्यासाठी लागणाऱ्या क्षमता विकासासाठी विद्यार्थ्यांना संधी देते व विद्यार्थी अशा आव्हानांना सामोरे जाऊन त्यावर उपाय शोधतात.", isGreen: true },
        { text: "लागू नाही" }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 The school provides opportunities for students to develop capacity needed to face various socio-economic challenges, and students face such challenges and find solutions.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/"
    }
  ...
  39: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ विद्यार्थी एकविसाव्या शतकातील कौशल्यांमध्ये निष्णात होऊन त्याचा दैनंदिन जीवनात वापर करतात.", isGreen: true },
        { text: "लागू नाही" }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students become proficient in 21st-century skills and apply them in their daily lives.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1AqFM-"
    }
  ...
  40: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शाळा वर्गातील कृती कार्यक्रमात व अध्यापनात भारताचा वारसा, संस्कृती, सभ्यता, भारतीय मूल्यांचे ज्ञान याची दखल घेते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 The school takes note of India's heritage, culture, civilization, and knowledge of Indian values in classroom activities and teaching.", isGreen: true },
  ...
  41: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ शिक्षक वर्गातील उपक्रमांमध्ये भारतातील ज्ञानाचे पैलू एकत्रित करून अध्ययन-अध्यापन पद्धतींमध्ये स्वतः सहभागी होतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 Teachers integrate aspects of Indian knowledge into classroom activities and actively participate in teaching-learning methods.", isGreen: true },
  ...
  42: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ विद्यार्थ्यांच्या उपक्रमाची दखल जिल्हा, राज्य, राष्ट्रीय पातळीवर घेतली आहे.", isGreen: true },
        { text: "लागू नाही" }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students' initiatives are recognized at the district, state, and national levels.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1B4foWsK49NCKVQ3aeW7vkbJa-2PzgKT1"
    }
  ...
  43: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ शिक्षक वाचलेली माहिती केंद्र परिषदेमध्ये, तालुका, जिल्हास्तर प्रशिक्षणात इतर शिक्षकांबरोबर सामायिक करतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 Teachers share the read information with other teachers in cluster conferences, block, and district level trainings.", isGreen: true },
  ...
  44: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शिक्षक केंद्र/तालुका स्तरावर मोड्यूल, उपक्रम निर्मिती, शैक्षणिक साहित्य निर्मिती, नाविन्यपूर्ण योजना, प्रशिक्षणात मार्गदर्शक म्हणून योगदान देतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Teachers contribute as guides in module design, activity creation, teaching aid preparation, innovative schemes, and training at the cluster/block level.", isGreen: true },
  ...
  47: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेत स्वतंत्र ग्रंथालय आहे. नसेल तर ग्रंथालय पेट्यांचा वापर केला जातो.\n१.२ ग्रंथालयात विद्यार्थ्यांच्या प्रमाणात पुरेशी पुस्तके उपलब्ध आहेत.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 The school has a separate library. If not, library boxes are used.\n1.2 Sufficient books are available in proportion to the number of students.", isGreen: true },
  ...
  48: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१भाषापेटी, विज्ञानपेटी, गणितपेटी यांचा वापर अध्ययन अध्यापनात केला जातो.\n२.२ प्रयोगशाळेतील साहित्य वापरून प्रयोग केले जातात. विद्यार्थ्यांना प्रयोग करण्याची संधी दिली जाते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Language kits, science kits, and mathematics kits are utilized in learning and teaching.\n2.2 Experiments are conducted using laboratory materials. Students are given opportunities to perform experiments.", isGreen: true },
  ...
  50: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळेत खुल्या जागेचा वापर विविध सहशालेय उपक्रमासाठी केला जातो.\n४.२ विद्यार्थ्यांच्या वयानुसार शाळेत विविध कलागुणांसाठीचे साहित्य उपलब्ध असून त्याचा वापर प्रभावीपणे केला जातो.", isGreen: true },
        { text: "लागू नाही" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/"
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Open space in the school is utilized for various co-curricular activities.\n4.2 Material for various artistic talents is available according to the age of students, and is used effectively.", isGreen: true },
        { text: "Not Applicable" }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/"
    }
  ...
  53: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ पुरुष व महिला यांच्यासाठी स्वतंत्र स्वच्छतागृह असून तसे बोर्ड लावलेले आहेत.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 Separate toilets are available for males and females, and signs/boards are put up.", isGreen: true },
  ...
  55: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ सहशालेय उपक्रमांच्या आयोजनासाठी शाळेकडे अतिरिक्त फर्निचर उपलब्ध असून त्याचा योग्य वापर केला जातो.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 Additional furniture is available in the school for organizing co-curricular activities and is used properly.", isGreen: true },
  ...
  56: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळेची संपूर्ण इमारत हवेशीर आणि अध्ययनास पूरक वातावरण निर्माण करणारी आहे.", isGreen: true }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 The entire school building is well-ventilated and creates a conducive learning environment.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1CAMACWoI0lwxdChrkkzJt2cDYoFZC1rG"
    }
  },
  ...
  58: {
    mr: {
      ...
      options: [
        { text: "१.१ आपत्ती व्यवस्थापनासाठी शाळेने योजना विकसित केली आहे", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 The school has developed a plan for disaster management.", isGreen: true },
  ...
  60: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ शाळा विद्यार्थ्यांकडून ऊर्जा, पाणी व कचरा व्यवस्थापन यांचे नियोजन करून योग्य प्रकारे अंमलबजावणी करून घेते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 The school ensures proper planning and implementation of energy, water, and waste management by students.", isGreen: true },
  ...
  68: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेमध्ये शैक्षणिक उपक्रमांना समर्थन देण्यासाठी आयसीटी लॅब/स्मार्ट क्लास सुविधा आहे.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 The school has ICT lab/smart class facility to support educational activities.", isGreen: true },
  ...
  69: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ शाळेकडून किमान २० Mb/s वेगाचे इंटरनेट प्रदान करते.\n४.२ विद्यार्थी, शिक्षक आणि शाळा ऑनलाइन कार्यासाठी इंटरनेट सुविधा वापरतात.", isGreen: true }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 The school provides internet with speed of at least 20 Mb/s.\n4.2 Students, teachers and the school use internet facilities for online work.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1DFjjpRBFJ-QaoRRbii3uiDr6NDRBPAYB"
    }
  },
  70: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ नोंदणी झालेल्या मुलांची माहिती मॅप केली जाते व ती प्रदर्शित करून शाळेत प्रवेश घेण्यासाठी प्रोत्साहित केले जाते.\n४.२ परिसरातील अनुसूचित जाती, अनुसूचित जमाती, भटक्या जमाती, आर्थिक दुर्बल घटक, अल्पसंख्यांक, CWSN या घटकातील मुलांचा शोध घेऊन शाळेच्या मुख्य प्रवाहात आणले आहे.", isGreen: true }
      ],
      hasEvidence: true
    },
    en: {
      ...
      options: [
        ...
        { text: "4.1 Information of enrolled children is mapped and displayed to encourage school admission.\n4.2 Children from Scheduled Castes, Scheduled Tribes, nomadic tribes, economically weaker sections, minorities, and CWSN in the area are tracked and brought into the mainstream of the school.", isGreen: true }
      ],
      hasEvidence: true
    }
  },
  ...
  72: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ शाळा विद्यार्थ्यांच्या शैक्षणिक विकासासाठी नजिकच्या शाळेतील पायाभूत सुविधा उपलब्ध करुन देण्याचे नियोजन करते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 The school plans to provide infrastructure facilities from nearby schools for the academic development of students.", isGreen: true },
  ...
  74: {
    mr: {
      ...
      options: [
        { text: "१.१ शाळेने सर्व माजी विद्यार्थ्यांच्या नोंदी घेतल्या आहेत.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 The school has recorded details of all alumni.", isGreen: true },
  ...
  76: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ नवीन कर्मचारी यांना त्यांची जबाबदारी व कर्तव्ये या बाबत शाळाप्रमुख / मुख्याध्यापक / व्यवस्थापन यांचेकडून मार्गदर्शन केले जाते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 New employees are guided by the school head / headmaster / management regarding their responsibilities and duties.", isGreen: true },
  ...
  77: {
    mr: {
      ...
      options: [
        { text: "१.१ मुख्याध्यापक लॉगबुक मध्ये वर्ग निरीक्षणाच्या नोंदी करतात.\n१.२ मुख्याध्यापक शिक्षक मूल्यांकनाचे पूर्वनिर्धारित निकष शिक्षकांच्या निदर्शनास आणून देतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Headmaster records classroom observations in the logbook.\n1.2 Headmaster brings the pre-determined criteria of teacher evaluation to the notice of teachers.", isGreen: true },
  ...
  79: {
    mr: {
      ...
      options: [
        ...
        { text: "२.१ कर्मचाऱ्यांची गुणग्राहकता ओळखून त्यांच्या विविध स्तरावरील (स्थानिक / केंद्र / तालुका/ जिल्हा/ राज्य / राष्ट्रीय) प्राप्त प्रशिक्षण प्रमाणपत्राची दखल घेऊन सन्मानपत्र देण्यात येते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "2.1 Recognition is given by acknowledging training certificates received at various levels (local / cluster / block / district / state / national) and certificates of appreciation are awarded.", isGreen: true },
  ...
  80: {
    mr: {
      ...
      options: [
        { text: "१.१ शिक्षक, मुख्याध्यापक/ शाळा प्रमुख यांच्याशी शाळेतील आव्हानात्मक बाबींसंबंधी चर्चा करतात.", isGreen: true },
    ...
    en: {
      ...
      options: [
        { text: "1.1 Teachers discuss challenging school matters with headmaster/school head.", isGreen: true },
  ...
  83: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ कर्मचाऱ्यांच्या क्षमतेनुसार कामांची जबाबदारी सोपवतात.\n३.२ सोपविलेल्या जबाबदारीचा आढावा नियमितपणे घेतला जातो.", isGreen: true },
  ...
  85: {
    mr: {
      ...
      options: [
        ...
        { text: "३.१ शाळा सहाध्यायी अध्यापन आणि निवृत्त शिक्षक, माजी विद्यार्थी, स्वयंसेवक व समुपदेशक इत्यादींच्या सहाय्याने शाळेतील अध्ययन अध्यापन प्रक्रिया समृद्ध करते.", isGreen: true },
    ...
    en: {
      ...
      options: [
        ...
        { text: "3.1 The school enriches the teaching-learning process in the school with the help of peer teaching and retired teachers, alumni, volunteers, and counselors etc.", isGreen: true },
  ...
  86: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ मुख्याध्यापक व शिक्षकांच्या वर्ग अध्यापनाविषयी पालक व विद्यार्थ्यांकडून अभिप्राय प्राप्त करून घेऊन कार्यवाही केली जाते.", isGreen: true }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "1.4 The headmaster takes action after receiving feedback from parents and students about the classroom teaching of teachers.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1ELnMUe9Up-j98rY6G3-ZjHPtSTItE"
    }
  },
  87: {
    mr: {
      ...
      options: [
        ...
        { text: "४.१ विद्यार्थी पायाभूत सुविधांचा वापर करून समाधानी आहेत.", isGreen: true }
      ],
    ...
    en: {
      ...
      options: [
        ...
        { text: "4.1 Students are satisfied using the infrastructure facilities.", isGreen: true }
      ],
      evidenceUrl: "https://drive.google.com/drive/folders/1EO4LqhtplBN7elBebWibu71s37_"
    }
  }
...
function TeacherSqafPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      {/* Hide header and sidebar if viewing detailed full-screen standard */}
      <div className={activeStandardDetails !== null ? "hidden" : "block"}>
         <TeacherHeader />
         <TeacherSidebar />
      </div>

      <main className={`${activeStandardDetails !== null ? "" : "lg:pl-64 pt-16"} min-h-screen transition-all duration-300`}>
                ...
                <div className="w-full max-w-lg p-5 md:p-8 flex flex-col space-y-6">
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="space-y-3">
                      {currentDetail[selectedLang].options.map((opt, idx) => {
                        const isSelected = selectedOptions[activeStandardDetails] === idx;
                        return (
                          <div
                            key={idx}
                            onClick={() => selectOption(activeStandardDetails, idx)}
                            className={`rounded-2xl p-5 border transition-all text-[13px] font-extrabold leading-relaxed cursor-pointer hover:scale-[1.01] hover:border-slate-300 ${
                              isSelected
                  ...
                  {currentDetail[selectedLang].evidenceUrl ? (
                    <div className="space-y-4 pt-4">
                      <h3 className="text-lg font-black text-slate-900">
                        {selectedLang === "mr" ? "पुरावे" : "Evidences"}
                      </h3>
                      <a 
                        href={currentDetail[selectedLang].evidenceUrl}
                        target="_blank"
                    ...
                    <PhotoUploader standardId={activeStandardDetails} lang={selectedLang} />
                  )}
                    ...
                    <div className="bg-white border border-slate-900 rounded-[1.5rem] p-6 w-full relative shadow-sm flex flex-col justify-between h-full">
                      <div>
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <div className="size-6 border-2 border-slate-900 rounded bg-slate-900 flex items-center justify-center shrink-0">
                    ...
                    <div className="bg-white border border-slate-900 rounded-[1.5rem] p-6 w-full relative shadow-sm flex flex-col justify-between h-full">
                      <div>
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <div className="size-6 border-2 border-slate-600 rounded bg-white shrink-0"></div>
                        </div>
                        <hr className="border-slate-900/40 mb-4" />
                        <p className="text-[14px] text-slate-700 mb-6">{t.downloadPdfDesc}</p>
                      </div>
                      <div className="flex justify-end mt-auto">
                        <button className="bg-[#1e1b4b] text-white px-8 py-3 rounded-3xl text-sm font-medium hover:bg-slate-800 transition-colors shadow-sm">
                          {t.downloadBtn}
                        </button>
                      </div>
                    </div>
