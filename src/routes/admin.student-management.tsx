    ...
    <div className="p-8 space-y-8">
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            ...
            <p className="text-[#6B7280] max-w-xl text-sm font-medium leading-relaxed">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        {subModules.map((m, i) => (
          ...
          >
            <Link
              to={m.to as any}
              className="relative block h-full bg-white border border-black/5 rounded-2xl p-6 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 hover:scale-[1.01]"
            >
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 p-[2px] bg-gradient-to-br ${m.color} rounded-2xl -z-10`}
              />
              ...
              <div className="relative z-10 flex flex-col h-full justify-between gap-6">
                <div className="space-y-4">
                  <div
                    className={`size-12 rounded-xl bg-gradient-to-br ${m.color} flex items-center justify-center shadow-lg group-hover:rotate-6 transition-all duration-500`}
                  >
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <div
            key={i}
            className="p-5 bg-white border border-black/5 rounded-2xl shadow-sm flex flex-col items-center text-center gap-1.5"
          >
