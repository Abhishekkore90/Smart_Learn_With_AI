        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5">
          {teachers.map((t, i) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-white rounded-2xl p-5 border border-black/5 shadow-sm group hover:border-amber-200 hover:shadow-md transition-all"
            >
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="size-11 rounded-xl bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600 text-lg font-black">
                    {t.fullName[0]}
                  </div>
                  <div>
                ...
                <button className="w-full py-3 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-amber-500 transition-all shadow-md hover:shadow-amber-500/20">
                  Review Credentials
                </button>
              </div>
            </motion.div>
          ...
          {teachers.length === 0 && (
            <div className="col-span-full py-12 text-center bg-white rounded-2xl border border-dashed border-slate-200">
              <GraduationCap className="size-10 text-slate-300 mx-auto mb-3" />
